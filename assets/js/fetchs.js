const grid_proyecto = document.getElementById("grid-proyecto");
...
function addProyecto(item){
    ...
    <img
      src="assets/img/proyectos/${item.src}"
      class="card-img align-self-center proyectoSoft"
      alt="${item.src}"
    />
    <div class="card-body">
